...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!./../../css-loader/index.js?{\"sourceMap\":false}!./../../postcss-loader/index.js!./normalize.css", function() {
			var newContent = require("!!./../../css-loader/index.js?{\"sourceMap\":false}!./../../postcss-loader/index.js!./normalize.css");
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../css-loader/index.js?{\"sourceMap\":false}!./../../postcss-loader/index.js!./skeleton.css", function() {
			var newContent = require("!!./../../css-loader/index.js?{\"sourceMap\":false}!./../../postcss-loader/index.js!./skeleton.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
